...
export default function SaleForm(props: SaleFormProps) {
  ...
  return (
    <Form<FormValues> className="sale-form" form={form} onFinish={handleSubmit}>
      <Flex align="center" style={{ height: "100%" }} justify="space-between" vertical>
        <Flex gap={18} vertical>
          <Form.Item name="sellCurrency" label="販賣幣值" colon={false}>
            <InputCoin
              placeholder="遊戲幣"
          ...
          <Form.Item name="stock" label="存&emsp;&emsp;貨" colon={false}>
